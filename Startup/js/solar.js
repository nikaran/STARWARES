...
mercuryTimeline.fromTo('#mercury', 15, {rotation: 0}, {rotation: -360})
  .fromTo('#mercury .pos', 15, {rotation: 0, rotationY: 0,rotationX: -90}, {rotation: 360, rotationY: 0, rotationX: -90}, 0)

venusTimeline.fromTo('#venus', 30, {rotation: 0}, {rotation: -360}, 0)
  .fromTo('#venus .pos',30, {rotation: 0, rotationY: 0,rotationX: -90}, {rotation: 360, rotationY: 0, rotationX: -90}, 0)

earthTimeline.fromTo('#earth',40 , {rotation: 0}, {rotation: -360}, 0)
  .fromTo('#earth .pos', 40, {rotation: 0, rotationY: 0,rotationX: -90}, {rotation: 360, rotationY: 0, rotationX: -90}, 0)

marsTimeline.fromTo('#mars', 60, {rotation: 0}, {rotation: -360}, 0)
  .fromTo('#mars .pos', 60, {rotation: 0, rotationY: 0,rotationX: -90}, {rotation: 360, rotationY: 0, rotationX: -90}, 0)

jupiterTimeline.fromTo('#jupiter', 149.31, {rotation: 0}, {rotation: -360}, 0)
  .fromTo('#jupiter .pos', 149.31, {rotation: 0, rotationY: 0,rotationX: -90}, {rotation: 360, rotationY: 0, rotationX: -90}, 0)

jupiterTimeline.seek(30);

saturnTimeline.fromTo('#saturn', 360.85, {rotation: 0}, {rotation: -360}, 0)
  .fromTo('#saturn .pos', 360.85, {rotation: 0, rotationY: 0,rotationX: -90}, {rotation: 360, rotationY: 0, rotationX: -90}, 0)
